# Multi-AI Developer Governance Plan

This folder defines the v4.0.0 update plan for managing several human developers and AI Developers on the same Kabeeri project without unsafe overlap.

The plan adds a single Owner model, access tokens, locks, assignment governance, AI session output contracts, token budgets, and full auditability.
