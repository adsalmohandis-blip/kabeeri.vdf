...
Review the current Symfony implementation and improve basic tests and quality checks.
...
composer.json only if test tooling is required
```
...
3. Check routes, controllers, services, entities, auth, authorization, and forms/API errors where useful.
4. Check app container and routes.
