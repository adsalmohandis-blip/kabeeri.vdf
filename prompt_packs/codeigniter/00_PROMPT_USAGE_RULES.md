...
Use these rules with every CodeIgniter prompt in this pack.
...
```text
You are working on a CodeIgniter project.
...
```bash
git commit -m "Add CodeIgniter auth and user foundation"
```
