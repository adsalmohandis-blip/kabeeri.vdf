...
The framework should also include a shared common layer for rules repeated across all stacks:
...
The stack-specific packs should reference the common layer instead of repeating every rule forever.
