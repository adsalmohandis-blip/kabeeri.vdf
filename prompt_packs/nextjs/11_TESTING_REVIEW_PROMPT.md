...
Review the current Next.js implementation and improve basic quality checks.
...
```text
tests/
app/ or pages/ only for small fixes
components/ only for small fixes
...
1. Review current scripts: lint, build, test.
...
5. Fix small issues discovered during review.
...
- App passes lint/build or failures are explained.
