...
- Technical note: If unsure, ask ChatGPT whether a simple async service is enough or a queue is needed.
...
1. Ask whether the first release needs emails, webhooks, payments, AI APIs, file processing, or other integrations.
