...
Give the AI coding assistant the correct product and Express.js backend context before writing code.
...
- Is Express.js the main backend, API service, webhook receiver, or microservice?
...
3. Identify whether Express.js is the main backend, API service, webhook receiver, BFF, or small microservice.
