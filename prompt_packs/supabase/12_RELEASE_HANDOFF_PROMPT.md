...
Prepare a release handoff summary for the current Supabase implementation state.
...
2. List tables, policies, buckets, functions, and integrations created.
3. List how to run/apply locally or staging.
...
Confirm RLS/policies are documented.
```
