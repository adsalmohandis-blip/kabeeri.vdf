...
Prepare a release handoff summary for the current Astro implementation state.
...
2. List the main pages, layouts, components, content collections, forms, and integrations created.
3. List how to run the site locally.
