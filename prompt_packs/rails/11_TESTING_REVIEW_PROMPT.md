...
Review the current Rails implementation and improve basic tests and quality checks.
...
- Are you using Minitest or RSpec?
...
test/
spec/
app/ only for small fixes
README.md for test notes
Gemfile only if test tooling is required
```
...
3. Check models, controllers, auth, authorization, and forms/API errors where useful.
4. Check app boot and routes.
