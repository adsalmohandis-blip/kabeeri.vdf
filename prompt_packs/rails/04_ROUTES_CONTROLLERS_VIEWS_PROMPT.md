# 04 — Routes, Controllers, Views, and API Prompt

## Goal

Add routes, controllers, views, and API response foundation for the first release.
...
1. Review the app style: full-stack Rails, API-only, or hybrid.
2. Add only first-release routes.
3. Add simple controller structure.
4. Add views only if full-stack/server-rendered.
