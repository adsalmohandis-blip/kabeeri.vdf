...
Use these rules with every Laravel prompt in this pack.

## Main rule

Do not let the AI coding tool expand the scope.
...
```bash
git commit -m "Add Laravel auth and user profile foundation"
```
