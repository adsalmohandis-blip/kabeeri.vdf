# 10 — Core Features Prompt

## Goal

Create the first product-specific SvelteKit pages/features based on Kabeeri VDF planning documents.
...
2. Identify only the first-release pages/features.
3. Implement one small feature area, not the whole product.
4. Use existing layout, UI components, data helpers, and form patterns.
...
- Only first-release pages/features were created.
