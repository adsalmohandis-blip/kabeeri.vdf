...
Prepare a release handoff summary for the current SvelteKit implementation state.
...
2. List the main routes, components, load functions, server actions, API routes, and config created.
