...
- Executable work requires an approved task, an assignee, an access token, lock coverage, source provenance, and acceptance criteria.
- Task access tokens are different from AI usage tokens. Access tokens grant scoped permission; AI usage tokens measure cost.
...
- `TASK_ACCESS_TOKENS.md`
- `ACCESS_TOKEN_LIFECYCLE.md`
- `LOCKING_RULES.md`
