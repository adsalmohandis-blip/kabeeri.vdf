...
Create simple reusable Angular UI components and visual rules.
...
- Brand colors?
- RTL/Arabic?
- Angular Material or custom components?
...
1. Add Button/Card/Input/EmptyState/LoadingState/PageHeader if useful.
