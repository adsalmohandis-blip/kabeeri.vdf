# 00 — SvelteKit Prompt Pack Index
...
Provide a safe, beginner-friendly SvelteKit prompt pack that helps vibe developers build SvelteKit apps step by step after completing Kabeeri VDF planning documents.

## What this pack is

This pack is a set of structured prompts for AI coding assistants.

It helps AI work on SvelteKit projects in a controlled order.

## What this pack is not

This pack is not:

- a SvelteKit installer
- a Node.js installer
- a package manager
- a hosting setup tool
- a full app by itself
- a replacement for official SvelteKit documentation
...
| Prompt | Purpose |
|---|---|
| 01 | Give AI the product and SvelteKit context. |
| 02 | Review or prepare SvelteKit app structure. |
| 03 | Configure environment variables and API rules. |
| 04 | Add routing, layouts, and navigation foundation. |
| 05 | Add design system and reusable component foundation. |
| 06 | Add load functions and data fetching foundation. |
| 07 | Add authentication/users foundation if needed. |
| 08 | Add forms, actions, and validation foundation. |
| 09 | Add API routes/server logic if needed. |
| 10 | Add first product-specific features. |
