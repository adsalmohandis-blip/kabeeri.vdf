...
Review or prepare a clean React project structure.

## Context for the AI coding assistant

Organize the React codebase without implementing business features.
...
3. Explain where pages, components, hooks, services, and tests go.
