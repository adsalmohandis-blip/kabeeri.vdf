# 06 — Authentication and Users Prompt
...
- Is auth handled by a backend API or inside Next.js?
...
2. Identify auth approach: existing backend auth, NextAuth/Auth.js, Clerk, Supabase, custom JWT, or other.
