# 08 — Services and Business Logic Prompt

## Goal

Add services and business logic foundation for first-release actions.
...
2. Create service classes for business rules where useful.
3. Keep controllers thin.
4. Use models/services cleanly.
