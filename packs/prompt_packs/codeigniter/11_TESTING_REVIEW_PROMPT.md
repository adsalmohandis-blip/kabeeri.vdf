...
Review the current CodeIgniter implementation and improve basic tests and quality checks.
...
3. Check routes, controllers, services, models, auth, filters, and validation where useful.
4. Check app routes.
