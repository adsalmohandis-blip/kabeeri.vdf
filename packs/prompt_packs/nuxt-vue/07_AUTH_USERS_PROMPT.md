...
- Is auth handled by a backend API or inside Nuxt/Vue?
...
2. Identify auth approach: backend API auth, Nuxt server auth, Supabase, Firebase, Auth0, Clerk, custom JWT, or other.
