# 09 — Core Pages and Features Prompt

## Goal

Create the first product-specific pages/features based on Kabeeri VDF planning documents.
...
4. Use existing layout, UI components, composables, and data helpers.
