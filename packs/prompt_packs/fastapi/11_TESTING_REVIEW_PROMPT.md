...
Review the current FastAPI implementation and improve basic tests and quality checks.
...
pyproject.toml or requirements.txt if test tooling is required
```
...
3. Check API routes, auth, permissions, services, and error cases where useful.
4. Check app startup.
