...
Give the AI coding assistant the correct product and FastAPI context before writing code.

## Context for the AI coding assistant

This prompt is used before implementation starts. Its goal is to make AI understand the product, first release scope, API/backend purpose, frontend relationship, and what it must not build yet.
...
- Is FastAPI the main backend, API for a frontend, or a small service?
...
2. Identify the first release API/backend scope.
3. Identify whether FastAPI is the full backend or a microservice.
