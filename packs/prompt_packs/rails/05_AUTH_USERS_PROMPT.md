...
- Technical note: If unsure, ask ChatGPT to compare simple Rails auth options.
...
2. Choose an auth approach suitable for the project: built-in Rails patterns, Devise, session-based auth, API token/JWT, external provider, or none.
...
7. Do not add complex roles yet; that belongs to the authorization prompt.
