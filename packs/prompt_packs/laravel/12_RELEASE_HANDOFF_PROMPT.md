...
Prepare a release handoff summary for the current implementation state.
...
```text
README.md
docs/implementation-notes.md if the project has docs
...
2. List the main files and modules created.
3. List how to run the project locally.
4. List tests/checks to run.
