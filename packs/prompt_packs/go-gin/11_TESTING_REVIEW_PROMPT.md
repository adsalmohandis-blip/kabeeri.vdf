...
Review the current Go / Gin implementation and improve basic tests and quality checks.
...
- Are you using Go standard tests only or extra testing tools?

## Files and areas allowed for this prompt

```text
tests/
internal/ only for small fixes
README.md for test notes
go.mod only if test tooling is required
```
...
3. Check API routes, auth, permissions, services, repositories, and error cases where useful.
4. Check app startup.
