...
Review or prepare a clean Go / Gin project structure.

## Context for the AI coding assistant

This prompt organizes the Go codebase structure. It should not implement business features yet.
...
1. Check whether a Go project already exists.
...
5. Prefer simple folders first: cmd, internal, handlers, services, repositories, middleware, config.
...
- The user understands where routes, handlers, services, repositories, middleware, config, and tests should go.
