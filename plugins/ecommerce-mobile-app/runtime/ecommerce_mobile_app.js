...
function resolveRepoRootFromCli() {
  ...
  if (!cliEntry) {
    throw new Error("Ecommerce Mobile App runtime blocked: unable to resolve CLI entrypoint.");
  }
...
module.exports = createAppPluginRuntime(catalog["ecommerce-mobile-app"]);
