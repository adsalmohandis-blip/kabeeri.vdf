...
function buildBookingTasks(project, modules, deliveryMode = "structured") {
  ...
  const tasks = (modules.modules || []).map((module, index) => {
    ...
    return {
      ...
      file_boundaries: [
        "plugins/booking_builder/",
        ".kabeeri/booking.json",
        "docs/reports/",
        "plugins/booking_builder/bootstrap.js"
      ]
    };
  });
  return {
...
function buildBookingBundleState(plugin, mode, stage, nextExactAction) {
  const fallback = {
    ...
    bundle_path: "plugins/booking_builder",
    ...
    docs_surface: [
      "plugins/booking_builder/README.md",
      "plugins/booking_builder/docs/index.md",
      "plugins/booking_builder/docs/cli.md"
    ]
  };
