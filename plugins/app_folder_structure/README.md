...
- a strict pipeline contract handoff from `app_category_registry`
...
`kvdf app-folder create` fails closed unless `.kabeeri/app_pipeline_contract.json` exists and matches the selected app slug and category.
