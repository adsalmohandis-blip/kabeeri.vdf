...
function buildEcommerceTasks(project, modules, deliveryMode = "structured") {
  ...
  const tasks = (modules.modules || []).map((module, index) => {
    ...
    return {
      ...
      file_boundaries: [
        "plugins/ecommerce_builder/",
        ".kabeeri/ecommerce.json",
        "docs/reports/",
        "plugins/ecommerce_builder/bootstrap.js"
      ]
    };
  });
  return {
...
function buildEcommerceBundleState(plugin, mode, stage, nextExactAction) {
  const fallback = {
    ...
    bundle_path: "plugins/ecommerce_builder",
    ...
    docs_surface: [
      "plugins/ecommerce_builder/README.md",
      "plugins/ecommerce_builder/docs/index.md",
      "plugins/ecommerce_builder/docs/cli.md"
    ]
  };
