...
- Manifest: `plugins/kvdf_dev/plugin.json`
- Bootstrap entrypoint: `plugins/kvdf_dev/bootstrap.js`
- Runtime entrypoint: `plugins/kvdf_dev/runtime/index.js`
- Primary docs: `plugins/kvdf_dev/docs/index.md`
- Supporting docs: `plugins/kvdf_dev/commands/README.md`,
  `plugins/kvdf_dev/runtime/README.md`, `plugins/kvdf_dev/governance/README.md`,
  and `plugins/kvdf_dev/tests/README.md`
...
The plugin-owned bootstrap lives in `plugins/kvdf_dev/bootstrap.js`.
...
- `plugins/kvdf_dev/docs/site/index.html`
