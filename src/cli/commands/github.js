...
const { fileExists, readJsonFile, writeJsonFile, repoRoot } = require("../fs_utils");
...
function readGithubIssueMap() {
  return fileExists(".kabeeri/github/issue_map.json")
    ? readJsonFile(".kabeeri/github/issue_map.json")
    : { tasks: [], conflicts: [], items: [] };
}

function readGithubTeamFeedback() {
  return fileExists(".kabeeri/github/team_feedback.json")
