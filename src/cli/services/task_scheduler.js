const { buildTaskTemporaryQueueReport } = require("../commands/temp");
const { ensureTaskTrashState, moveTaskToTrash, restoreTaskFromTrash, taskTrashSummary } = require("./task_trash");
const { resolvePlannedAiCandidateFromList, buildPlannedAiCandidatePoolFromEntries } = require("./ai_planner");
...
module.exports = {
  ...
  routeTaskMovement,
  buildTaskSchedulerRouteRecord,
  recordTaskSchedulerRoute,
  nextRouteId,
  taskSchedulerSummary,
  buildTaskSchedulerLineage,
  resolveSchedulerTaskEvolution,
  buildTaskTrashRecovery,
  resolveSchedulerTaskTrack,
  compareDates,
