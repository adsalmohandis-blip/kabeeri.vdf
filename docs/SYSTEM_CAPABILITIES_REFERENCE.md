...
| UI UX Intelligence Plugin | Optional standalone UI/UX intelligence plugin that works offline in the MVP, provides deterministic product detection, a local catalog/search layer over the relocated CSV data, style and palette recommendations, typography and layout guidance, chart and icon guidance, accessibility checklists, anti-pattern detection, and Viber docs support. Phase 1 used a flat `_temp_meta/` staging contract and phase 2 relocates the approved CSV data into `plugins/ui_ux_intelligence/data/` and `plugins/ui_ux_intelligence/data/stacks/`. The runtime does not read `_temp_meta/`, external GitHub, or any AI API. | `plugins/ui_ux_intelligence/`, `kvdf ui-ux-intelligence status`, `kvdf ui-ux-intelligence source-status`, `kvdf ui-ux-intelligence catalog`, `kvdf ui-ux-intelligence search`, `kvdf ui-ux-intelligence recommend`, `kvdf ui-ux-intelligence design-system`, `kvdf ui-ux-intelligence checklist`, `kvdf ui-ux-intelligence docs`, `kvdf ui-ux-intelligence audit`, `kvdf plugins install ui_ux_intelligence`, `kvdf plugins uninstall ui_ux_intelligence` |
