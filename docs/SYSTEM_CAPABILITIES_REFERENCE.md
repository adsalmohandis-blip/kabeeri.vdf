...
| Naming Governance Core | Generates deterministic, track-separated machine IDs and human-readable titles for plans, versions, evolutions, and tasks without writing runtime state. | `docs/workflows/NAMING_GOVERNANCE_STANDARD.md`, `kvdf naming preview`, `kvdf naming validate` |
