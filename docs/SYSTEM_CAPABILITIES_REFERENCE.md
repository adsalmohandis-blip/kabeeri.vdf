...
| UI UX Intelligence Plugin | Optional standalone UI/UX intelligence plugin that works offline in the MVP, provides product detection, style and palette recommendations, accessibility checklists, anti-pattern detection, and Viber docs support, and uses a flat `_temp_meta/` staging contract before any relocation into plugin data folders. | `plugins/ui_ux_intelligence/`, `kvdf ui-ux-intelligence status`, `kvdf ui-ux-intelligence source-status`, `kvdf ui-ux-intelligence search`, `kvdf ui-ux-intelligence recommend`, `kvdf ui-ux-intelligence design-system`, `kvdf ui-ux-intelligence checklist`, `kvdf ui-ux-intelligence docs`, `kvdf ui-ux-intelligence audit`, `kvdf plugins install ui_ux_intelligence`, `kvdf plugins uninstall ui_ux_intelligence` |
