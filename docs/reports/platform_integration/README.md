...
| `v2_6_owner_verify/` | `../../../knowledge/governance/`, `kvdf owner`, `kvdf task verify` |
| `v2_7_token_costs/` | `../../../knowledge/ai_cost_control/`, `kvdf pricing`, `kvdf usage` |
| `v2_8_sprint_analytics/` | `../../../knowledge/agile_delivery/`, `kvdf sprint`, AI usage summaries |
