...
an ecommerce platform with a Laravel backend, React frontend, optional mobile
delivery track, payments, shipping, customer accounts, and an admin
back-office. The scope is intentionally narrow enough for the docs-first gate
to resolve product boundaries before implementation begins.
