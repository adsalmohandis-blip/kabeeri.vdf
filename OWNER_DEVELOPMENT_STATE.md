...
- 2026-05-09: Finished task governance/tracking consolidation. `task_governance/` was removed, policy lives in `governance/TASK_GOVERNANCE.md`, and `task_tracking/` now stays focused on task schemas, templates, intake, provenance schema, examples, states, reviews, and AI logs.
